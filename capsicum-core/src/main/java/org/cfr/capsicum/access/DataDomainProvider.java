...
/**
 * A {@link DataDomain} provider that provides a single instance of DataDomain configured
...
public class DataDomainProvider implements Provider<DataDomain> {
     ...
     */
    @Nonnull
    protected DataDomain createDataDomain(@Nonnull final String name) {
        return cayenneRuntimeContext.createDataDomain(name);
    }
     ...
     */
    @Nonnull
    protected DataNode createDataNode(@Nonnull final String name) {
        return cayenneRuntimeContext.createDataNode(name);
    }

    /**
     *
     * @return Returns new initialised DataDomain.
     * @throws Exception Raise during initialisation of DataDomain.
     */
